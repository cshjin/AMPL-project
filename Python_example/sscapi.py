...
if __name__ == "__main__":
    ...
    def print_data(d):
        ...
        while (name != None):
            ...
            if type == PySSC.STRING:
                outstr += ' str: ' + name + '    \'' + \
                    ssc.data_get_string(d, name) + '\''
            elif type == PySSC.NUMBER:
                outstr += ' num: ' + name + '    ' + \
                    str(ssc.data_get_number(d, name))
            elif type == PySSC.ARRAY:
                outstr += ' arr: ' + name + \
                    '    [ ' + arr_to_str(ssc.data_get_array(d, name)) + ' ]'
            elif type == PySSC.MATRIX:
                outstr += ' mat: ' + name + \
                    '    [ ' + mat_to_str(ssc.data_get_matrix(d, name)) + ' ]'
            else:
                outstr += ' inv! ' + name
    ...
    def simtest():
        ...
        ssc.data_set_string(dat, "ur_tou_sched_weekday",
                            "")
        ssc.data_set_string(dat, "ur_tou_sched_weekend",
                            "")
        ...
        # calculate 30 year financial cashflow based on net energy and energy
        # value in each year
